"""
Django settings for nonprofit_portal project (minimal, dev-friendly).
"""
import os
...
ROOT_URLCONF = 'nonprofit_portal.urls'
...
WSGI_APPLICATION = 'nonprofit_portal.wsgi.application'

# Use SQLite for quick dev setup. Swap to Postgres via env if desired.
if os.environ.get('POSTGRES_HOST'):
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.environ.get('POSTGRES_DB', 'nonprofit'),
